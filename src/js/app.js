...
const accordion_btns = document.querySelectorAll(".faq__accordion");
...
document
  .getElementById("dashboard-selection")
...
termsOfService.addEventListener("click", (e) => {
  ...
  openModal();
  document
    .getElementById("terms-of-service-modal")
    .classList.add("modal__body--show");
});
...
function closeModal() {
  ...
  document
    ...
    .classList.remove("modal__body--show");
  document
    .getElementById("terms-of-service-modal")
    .classList.remove("modal__body--show");
